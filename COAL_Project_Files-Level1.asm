...
right:
	...
	add XCOOR,dx
        ...
        .endif
          ...
          .if dx<= ax && ycoor <= cx ;moving over the first candy cane 	
	   mov dx,XJUMP
	   add XCOOR,dx
           .endif
	   ...
	   add XCOOR,dx
           .endif
             ...
             mov cl,Objectsy[1]
             sub cx,GROOT_ROWS
               .if dx<= ax && ycoor <= cx ;moving over the second candy cane 	
	        mov dx,XJUMP
	        add XCOOR,dx
             .endif
            mov ax,0
          ...
          .if XCOOR>= ax && dx <= cx ;moving between the second and last candy cane 	
	   mov dx,XJUMP
	   add XCOOR,dx
           .endif
          ...
          .if XCOOR>= ax && dx <= cx ;moving between the last candycane and end of screen 	
	   mov dx,XJUMP
	   add XCOOR,dx
           .endif
